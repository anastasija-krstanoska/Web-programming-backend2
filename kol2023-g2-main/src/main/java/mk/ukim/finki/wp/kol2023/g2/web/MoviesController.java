...
public class MoviesController {
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("director", directorService.listAll());
        model.addAttribute("genre", Genre.values());
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("movie", movieService.findById(id)); //go zemam filmot za editiranje
        model.addAttribute("director", directorService.listAll());
        model.addAttribute("genre", Genre.values());
    ...
    public String create(@RequestParam String name,
                         ...
                         @RequestParam Long director, Model model) {
